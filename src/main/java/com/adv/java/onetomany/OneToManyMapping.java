...
public class OneToManyMapping {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * //set up for 1 questions answer QuestionOneToMany que = new
		 * QuestionOneToMany();
		 * 
		 * que.setQuestionId(1212); que.setQuestion("What is Java?");
		 * 
		 * AnswerManyToOne ans = new AnswerManyToOne();
		 * 
		 * ans.setAnswerId(343); ans.setQuestion(que);
		 * ans.setAnswer("Java is programming language.");
		 * 
		 * AnswerManyToOne ans1 = new AnswerManyToOne();
		 * 
		 * ans1.setAnswerId(344); ans1.setQuestion(que);
		 * ans1.setAnswer("Java is used o build desktop applications.");
		 * 
		 * AnswerManyToOne ans2 = new AnswerManyToOne();
		 * 
		 * ans2.setAnswerId(345); ans2.setQuestion(que);
		 * ans2.setAnswer("Java uses OOPS conecpt.");
		 * 
		 * List<AnswerManyToOne> a = new ArrayList<AnswerManyToOne>(); a.add(ans);
		...
		//Fetching 
		  ...
		  System.out.println(q.getAnswer().size());
			...
			/*
			 * for(AnswerManyToOne s :q.getAnswer()) { System.out.println(s.getAnswer()); }
			 */
